...
export PATH="$HOME/.local/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/usr/sbin:/usr/local/sbin:/sbin"

[ -d ~/.bin_overwrite ] && export PATH="~/.bin_overwrite:$PATH"
[ -d ~/node_modules ] && export PATH="$PATH:~/node_modules"
...
export UCS_PY_PATH="$HOME/git/ucs"
